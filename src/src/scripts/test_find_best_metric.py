...
from spr_functions.other_recs_with_diff_metrics import OtherRecsALSRecommenderKNN, OtherRecsALSRecommenderKNN_weight
...
if __name__ == "__main__":
    ...
    for metr in metrics:
        ...
        model = OtherRecsALSRecommenderKNN(train_data=train_data,
                                           ...
                                           vad_data_tr=vad_data_tr,
                                           loader=loader)
        hyperparams = {'metric': metr, 'alpha': 40, 'factors': 64, 'K': 5}
