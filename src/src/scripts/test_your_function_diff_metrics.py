...
from scripts.preprocess_ml1m import DataLoader
...
from spr_functions.other_recs_with_mult_metrics import OtherRecsALSRecommender, OtherRecsALSRecommenderKNN
...
if __name__ == "__main__":
    ...
    for method in implemented_methods:
        ...
        print("=" * 89)
        print(
            "| Func: {}| n20 {:4.2f} | n100 {:4.2f} | r20 {:4.2f} | "
            "r50 {:4.2f}".format(method.__name__, n20, n100, r20, r50)
        )
        print("=" * 89)
